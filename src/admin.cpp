...
int nvm_admin_ns_info(nvm_aq_ref ref, struct nvm_ns_info* info, uint32_t ns_id, void* ptr, uint64_t ioaddr, bool lbaf_4k)
{
    nvm_cmd_t command;
    nvm_cpl_t completion;
    ...
    info->lba_data_size = lbaf_4k ? 4096 : (1 << _RB(lba_format, 23, 16));
